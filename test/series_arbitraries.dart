...
//  Gen<Series<int, double>> dupSeriesDoubleWithNA() {
//    for {
//    n <- Gen.choose(0, 20)
//    lst <- Gen.listOfN(n, Gen.frequency((9, Gen.chooseNum(-1e3, 1e3)), (1, na.to[Double])))
...
//  Gen<Series<DateTime, double>> seriesDateTimeDoubleNoDup() {
//    for {
//    n <- Gen.choose(0, 40)
...
//  Gen<Series<DateTime, double>> seriesDateTimeDoubleWithNA() {
//    for {
//    n <- Gen.choose(0, 20)
//    lst <- Gen.listOfN(n, Gen.frequency((9, Gen.chooseNum(-1e3, 1e3)), (1, na.to[Double])))
//    ix <- Gen.listOfN(n, IndexArbitraries.getDate)
