 ...
 */
abstract class Splitter<I, OL, OR> {
  Splitted<OL, OR> call(Index<I> i);
//}
...
class Splitted<OL, OR> {
  final Index<OL> left;
  final Index<OR> right;
  Splitted(this.left, this.right);
}
