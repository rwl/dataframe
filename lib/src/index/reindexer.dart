...
library saddle.index.reindexer;
...
//  Option<Array<int>> rTake;
   ...
   */
  ReIndexer<T> swap() => new ReIndexer(rTake, lTake, index);
//}
//
//class ReIndexer {
  /**
   ...
   */
  ReIndexer /*<T>*/ (List<int> lft, List<int> rgt, Index<T> ix) {
    lTake = lft;
    rTake = rgt;
    index = ix;
  }
