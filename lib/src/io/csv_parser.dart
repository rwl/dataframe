...
//    Frame(columns : _*).row(params.skipLines -> *)
  ...
  /*private*/ extractFields(String line, Unit callback(String, Int),
      Array<int> locs, CsvParams params) {
    ...
    if (locIdx < locs.length && curFld == locs(locIdx) && curBeg < slen) {
      inQoff = (carr(curEnd - 1) == quote && stripQuote) ? 1 : 0;
  ...
  /*private*/ Array<String> extractAllFields(String line, CsvParams params) {
    val quote = params.quoteChar;
    val sep = params.separChar;
    val stripQuote = !params.withQuote;
